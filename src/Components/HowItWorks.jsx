    ...
    <div className="container mx-auto my-11">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        {steps.map((step, index) => (
          <div key={index} className="bg-white bg-opacity-50 shadow-lg rounded-lg p-6 text-center">
            {step.icon}
            <h3 className="text-xl text-green-900 font-semibold mb-2">{step.title}</h3>
